    ...
    public static void synchronizeClocks(List<Node> nodes) {
        ...
        for (Node node : nodes) {
            if (node.id != TIME_SERVER_NODE) {
                ...
                System.out.println("\nNode " + node.id + " clock: " + node.clock + " + offset: " + node.offset);
                System.out.println("Node " + node.id + " nodeTime: " + nodeTime);
                System.out.println("Node " + node.id + " offset to adjust: " + offset);
                node.adjustClock(offset);
                System.out.println("Node " + node.id + " adjusted clock: " + node.clock);
            }
        }
    }
